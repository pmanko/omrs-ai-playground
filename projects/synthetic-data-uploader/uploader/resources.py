...
class Observation:
  ...
  def openmrs_convert(self, new_patient_id: str,
    ...
    # Ensure OpenMRS concept system is used for codes (avoid LOINC here)
    if 'code' in self.base.json and 'coding' in self.base.json['code'] and self.base.json['code']['coding']:
      self.base.json['code']['coding'][0]['system'] = 'http://openmrs.org/concepts'
    if 'valueCodeableConcept' in self.base.json and 'coding' in self.base.json['valueCodeableConcept'] and self.base.json['valueCodeableConcept']['coding']:
      self.base.json['valueCodeableConcept']['coding'][0]['system'] = 'http://openmrs.org/concepts'
